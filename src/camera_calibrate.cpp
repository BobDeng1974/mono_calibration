...
static bool runAndSave(const string& outputFilename,
		...
		Size boardSize, float squareSize, float aspectRatio, int flags,
        Mat& cameraMatrix, Mat& distCoeffs, double &totalAvgErr) {
...
bool camera_calibrate(int width, int height, vector<Mat> img, const string& camera_param_file, double &totalAvgErr) {
